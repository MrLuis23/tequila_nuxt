...
<style scoped>
    ...
    .v-application .text-xl-h4, .v-application .text-lg-h6,
    .v-application .text-md-h6 .v-application .text-sm-subtitle-2,
    .v-application .text-xs-subtitle-2
    .v-application .text-sm-caption, .v-application .text-xs-caption{
